...
with tab1:
  ...
  st.sidebar.write(f"Rentang Nilai : :green[**{df_final['age'].min()}**] - :red[**{df_final['age'].max()}**]")
  st.sidebar.write("")
  ...
  st.sidebar.write(f"Rentang Nilai: :green[**{df_final['trestbps'].min()}**] - :red[**{df_final['trestbps'].max()}**]")
  st.sidebar.write("")
  ...
  st.sidebar.write(f"Rentang Nilai: :green[**{df_final['chol'].min()}**] - :red[**{df_final['chol'].max()}**]")
  st.sidebar.write("")
  ...
  st.sidebar.write(f"Rentang Nilai: :green[**{df_final['thalach'].min()}**] - :red[**{df_final['thalach'].max()}**]")
  st.sidebar.write("")
  ...
  st.sidebar.write(f"Rentang Nilai: :green[**{df_final['oldpeak'].min()}**] - :red[**{df_final['oldpeak'].max()}**]")
  st.sidebar.write("")
